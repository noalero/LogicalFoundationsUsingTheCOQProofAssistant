...
(** **** Exercise: 1 star, standard, optional (mult_is_O) *)
Lemma mult_is_O :
...
(** **** Exercise: 3 stars, standard, optional (even_double_conv) *)
...
Example even_100 : Even 100.

(** The most direct way to prove this is to give the value of [k]
    explicitly. *)

Proof. unfold Even. exists 50. reflexivity. Qed.
...
Example even_100' : even 100 = true.
Proof. reflexivity. Qed.
...
Example not_even_101 : even 101 = false.
Proof.
  (* WORKED IN CLASS *)
  reflexivity.
Qed.
